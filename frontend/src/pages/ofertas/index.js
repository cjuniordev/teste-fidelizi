    ...
    return (
        <>
            ...
            <div className="container center-items">
                ...
                {
                    error ?
                        <div id="not-found" className="container center-items">
                            <div className="not-found-wrap">
                                <img src={question} alt="Não encontrado" className="not-found-img"/>
                                <span>404</span>
                            </div>
                            <h1>Oferta não encontrada!</h1>
                            <p>A oferta que você procura não foi encontrada ou não existe mais.</p>
                            <footer>
                        ...
                        <div className="card">
                            ...
                            <main className="card-content">
                                ...
                                <div className="rules">
                                    ...
                                    <ul>
                                        <li>Oferta exclusiva para clientes novos, não participantes do programa de fidelidade do
                                            estabelecimento <strong>Demonstração FideliZi</strong></li>
                                        ...
                                        <li>A oferta estará válida na área de resgate do FideliZi por <strong>15 dias</strong> a
                                            partir da ativação
                                        </li>
                                        <li>Não cumulativo com outras promoções ou ofertas</li>
                                        <li>O valor total da oferta deverá ser gasto em uma única visita (não haverá troco ou
                                            crédito)
                                        </li>
